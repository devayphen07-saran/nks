...
export default [
  ...
  // Platform management
  { code: 'STORE',           label: 'Store',            description: 'Store/tenant management'                    },
  { code: 'SUBSCRIPTION',    label: 'Subscription',     description: 'Subscription plans and lifecycle'           },
  { code: 'BILLING',         label: 'Billing',          description: 'Platform billing and revenue'               },
  // Business domain
  { code: 'ORDER',           label: 'Order',            description: 'Sales orders'                               },
