...
export const ErrorCode = {
  ...
  AUTH_FORBIDDEN_STORE_ACCESS: 'AUTH_FORBIDDEN_STORE_ACCESS',
  ...
  LOOKUP_SYSTEM_VALUE_READONLY: 'LOOKUP_SYSTEM_VALUE_READONLY',
...
export const ErrorMessages: Record<string, string> = {
  ...
  [ErrorCode.AUTH_FORBIDDEN_STORE_ACCESS]: 'You do not have access to this store.',
  ...
  [ErrorCode.LOOKUP_SYSTEM_VALUE_READONLY]: 'System-seeded lookup values cannot be modified or deleted.',
